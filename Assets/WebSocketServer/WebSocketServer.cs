...
namespace WebSocketServer {
    ...
    public class WebSocketServer : MonoBehaviour
    {
        ...
        void Update() {
            ...
            while (events.TryDequeue(out wsEvent)) {
                if (wsEvent.type == WebSocketEventType.Open) {
                    ...
                    this.OnOpen(wsEvent.connection, connectedTcpClient);
        ...
        public virtual void OnOpen(WebSocketConnection connection, TcpClient tcpClient)
        {
            //Debug.Log("Client opened the connection.");
        }
